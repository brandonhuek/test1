...
lang = {
    "Español": {
        ...
        "nombre": lang["nombre"],
        "empresa": lang["empresa"],
        "direccion": lang["direccion"],
        "telefono": lang["telefono"],
        "email": lang["email"],
        "observaciones": lang["observaciones"],
        "modalidad": lang["modalidad"],
        "bolsas": "Indica cuántas bolsas quieres por cada formato:",
        "minimo": "El mínimo para la modalidad",
        "tipo_envio": lang["tipo_envio"],
        "recargo_eq": lang["recargo_eq"],
        "imagenes": lang["imagenes"],
        "total_presupuesto": "Total presupuesto",
        "descargar": lang["descargar"],
        "gracias": "✅ ¡Gracias por tu solicitud!\n\nHemos recibido su petición correctamente. Nuestro departamento se pondrá en contacto con la mayor brevedad posible.",
        "volver": lang["volver"]
    },
    "English": {
